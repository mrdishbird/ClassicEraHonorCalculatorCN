...
describe('ProgressionPlanningComponent', () => {
  ...
  beforeEach(() => {
    ...
    providers: [provideCharts(withDefaultRegisterables()), { provider: ComponentFixtureAutoDetect, useValue: true }, provideTranslateService({ fallbackLang: 'en', loader: { provide: TranslateLoader, useClass: TranslateNoOpLoader } })],
    imports: [
        BrowserModule,
        FormsModule,
        CountdownModule,
