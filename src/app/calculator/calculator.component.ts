...
export class CalculatorComponent {
    ...
    constructor(private router: Router, private calculationService: CalculationService, private pathfindingService: PathfindingService, public translate: TranslateService) {
        const rCurrent = Rank.RankMap.get(this.currentRankNum);
        if (!rCurrent) {
            throw new Error(`Could not find Rank ${this.currentRankNum} in RankMap`);
        }
