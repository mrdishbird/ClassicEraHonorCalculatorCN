...
@Component({
    ...
    imports: [CountdownComponent, RouterLink, RouterLinkActive, TranslatePipe]
})
export class HeaderComponent {
    supportedLangs = ['en', 'zh'];

    constructor(@Inject(APP_BASE_HREF) public baseHref: string, public translate: TranslateService) {
    }
